...
echo =============================================================================
echo   Member P1 tests  ^(HEADED + SlowMo — demos / debugging — filter: %FILTER%^)
echo =============================================================================
echo.
...
rem Visible browser + slowed actions (see headed.runsettings / GlobalTestHooks).
set "HEADED=1"
set "PLAYWRIGHT_SLOWMO=1000"
